#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('c:\\Users\\Jeysson\\.trae\\extensions\\wallabyjs.console-ninja-1.0.504-universal\\out\\buildHook\\index.js').default({tool: 'astro', checkSum: '20d46dea78dbbfcc05d6a9UBoHUktQDgJVVlBWUVQJA1UFVAlR', mode: 'build', condition: true}); } catch(cjsError) { try { import('file:///c:/Users/Jeysson/.trae/extensions/wallabyjs.console-ninja-1.0.504-universal/out/buildHook/index.js').then(m => m.default.default({tool: 'astro', checkSum: '20d46dea78dbbfcc05d6a9UBoHUktQDgJVVlBWUVQJA1UFVAlR', mode: 'build', condition: true})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
